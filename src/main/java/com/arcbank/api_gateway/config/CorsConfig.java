...
public class CorsConfig {
    ...
    /**
     * Maneja CORS a nivel de WebFilter (preflight OPTIONS).
     * Esto permite que los OPTIONS pasen sin 403.
     */
    @Bean
    ...
    /**
     * Filtro global que deduplica los headers CORS en la respuesta.
